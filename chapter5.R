...
loan3000 <- read.csv(file.path(PSDS_PATH, 'data', 'loan3000.csv'), sep = ";")
loan_data <- read.csv(file.path(PSDS_PATH, 'data', 'loan_data.csv'), sep = ";")
loan_data$outcome <- ordered(loan_data$outcome, levels=c('paid off', 'default'))
full_train_set <- read.csv(file.path(PSDS_PATH, 'data', 'full_train_set.csv'), sep = ";")
...
png(filename="loan_tree_model.png", width = 400, height = 300)
...
png(filename="loan_rpart.png", width = 300, height = 400)
...
png(filename="impurity.png", width = 300, height = 300)
...
save(loan3000, file="loan300.rdata")
...
png(filename=file.path(PSDS_PATH, 'figures', 'rf_accuracy.png') , width = 300, height = 250)
...
png(filename=file.path(PSDS_PATH, 'figures','loan_random_forest.png'), width = 300, height = 340)
...
png(filename=file.path(PSDS_PATH, 'figures','loan_var_imp.png'), width = 300, height = 450)
...
png(filename=file.path(PSDS_PATH, 'figures', 'loan_xgboost.png'), width = 300, height = 340)
