...
session_times <- read.csv(file.path(PSDS_PATH, 'data', 'web_page_data.csv'), sep = ";")
session_times[,2] <- session_times[,2] * 100
four_sessions  <- read.csv(file.path(PSDS_PATH, 'data', 'four_sessions.csv'), sep = ";")
click_rate <-  read.csv(file.path(PSDS_PATH, 'data', 'click_rates.csv'), sep = ";")
imanishi <-  read.csv(file.path(PSDS_PATH, 'data', 'imanishi_data.csv'), sep = ";")
